...
export const reservationStoreSlice: StateCreator<AppStore, [], [], ReservationStore> = (set, get) => ({
  ...
  cancelReservation: async (id: string) => {
    ...
    rejectReservation: async (id: string) => {
        ...
        try {
            const res = await axios.patch(`${BASE_URL}/api/reservation/reject`, {reservationId: id},
                {
                    headers: {
                        "Authorization": "Bearer " + get().loginStateRes.data
                    }
    ...
    confirmReservation: async (id: string) => {
        ...
        try {
            const res = await axios.patch(`${BASE_URL}/api/reservation/confirm`, {reservationId: id},
                {
                    headers: {
                        "Authorization": "Bearer " + get().loginStateRes.data
                    }
